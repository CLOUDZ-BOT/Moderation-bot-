...
execute(message) {
    ...
    if (!queue.playing) {
      ...
      const playembed = new MessageEmbed().setColor("#303037")
      .setAuthor(`${message.author.username} resumed the music!`, "https://cdn.discordapp.com/emojis/854540645507137576.gif")
      //send the approve
