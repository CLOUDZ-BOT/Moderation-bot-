  ...
  async execute(message, args, client) {
    ...
    switch (args[0]) {
      ...
      default:
        ...
        .setDescription("Filters", "`bassboost`, `8D`, `vaporwave`, `nightcore`, `phaser`, `tremolo`, `surrounding`, `pulsator`, `subboost`, `chorus`, `karaoke`, `sofa`, `desilencer`, `clear`")
    ...
    try {
      ...
      message.channel.send(new MessageEmbed()
      .setColor("#303037")
      .setAuthor("Applying : " + args[0], "https://cdn.discordapp.com/emojis/854540645507137576.gif")).then(msg =>{
