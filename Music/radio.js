...
**34: ** [\`${Radiostations[34 - 1].split(" ")[0]}\`](${Radiostations[34 - 1].split(" ")[1]})`, inline: true
    ...
    const song = {
      title: args2[0],
      url: args2[1],
      thumbnail: "https://cdn.discordapp.com/emojis/815167689331965994.gif",
      duration: 10000,
    };
    let a, b;
    if (!serverQueue) {
    ...
    if (!serverQueue)
      message.channel.send(new MessageEmbed().setColor("#303037")
        .setDescription(`**<:s_voice:854540365112541224> Joined \`${channel.name}\` <:s_channel:854566619099037696> bound \`#${message.channel.name}\`**`)
        .setFooter(`${message.author.username}#${message.author.discriminator}`));
    //send Search something embed
    message.channel.send(new MessageEmbed().setColor("#303037")
      .setDescription(`**<:s_searching:854543865053577228> Searching  \`${Radiostations[i - 1].split(" ")[0]}\`**`));
    //mute yourself
