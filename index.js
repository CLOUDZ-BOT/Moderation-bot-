...
client.on("message", async (message) => {
  ...
  if(message.content.startsWith(`${prefix}embed`)){
    ...
    .setFooter("Powered by Shadow Music", client.user.displayAvatarURL())
    //delete the Command
...
//command Handler DO NOT TOUCH
 ...
 if (timestamps.has(message.author.id)) {
   ...
   if (now < expirationTime) {
     ...
     return message.reply(
      new MessageEmbed().setColor("#303037")
 ...
 try {
   ...
   console.error(error);
   message.reply( new MessageEmbed().setColor("#303037")
